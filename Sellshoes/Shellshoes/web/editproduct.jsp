				...
				<ul class="navbar-nav nav-right">
					...
					<li class="nav-item avt-wrapper">
						<div class="avt dropdown">
							<img src="image/chamsoc.png" alt="User image" class="dropdown-toggle"
									...
									<table>
										...
										<tbody>
											...
											<tr>
												...
												<input name="pid" type="text" hidden value="${p.pID}" readonly />

												<td>
													<input type="text" name="pName" value="${p.pName}" readonly>
												</td>
												<td>
													<input type="text" name="img" value="${p.imge}" readonly>

												</td>
												<td>
													<input name="number" type="text" value="${p.number}">
												</td>
												<td>
													<input name="price" type="text" value="${p.price}">vnđ
												</td>
												<td>
													<select name="brand">
														<c:forEach items="${listB}" var="b">
															<option value="${b.brandID}" ${p.bID==b.brandID ? 'selected'
																: '' }>${b.brandName}</option>
														</c:forEach>
													</select>
												</td>
