        ...
        <section>
            <div class="bannerVideo" id="slideshow">
                <video src="video/y2meta.com - Quảng cáo_ Nike Air Max 2017 - Nike.mp4" autoplay muted loop
                    class="active"></video>
                <video src="video/y2meta.com - Video Quảng cáo giày Adidas.mp4" autoplay muted
                    loop></video>
                <video src="video/y2meta.com - Sinh viên FPoly Cần Thơ sản xuất TVC quảng cáo giày Vans đầy ấn tượng.mp4" autoplay muted loop></video>
            </div>
                ...
                <div class="content">
                    <div class="bannerText" id="slideshowText">
                        ...
                        <div>
                           ...
                           <br> Slogan “Impossible is nothing” đã gắn liền cùng Adidas ngay từ những ngày đầu thành lập.</p>
                        </div>
                        <div>
                            <h2>VANS</h2>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 title-travel-1">
                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 title-travel-1-2">
                        <div>
                            <h4><i class="far fa-calendar-alt"></i> October 3, 2022 &ensp; <i class="fas fa-pen"></i> by
                                ASIA
                            </h4>
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 title-travel-2">
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 title-travel-2-2">
                        <div>
                            <h4><i class="far fa-calendar-alt"></i> October 2, 2022 &ensp; <i class="fas fa-pen"></i> by
                                ASIA
                            </h4>
        ...
        <div class="email ">
            <div class="row">
                ...
                <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 email-title">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididu nt ut labore
                        et dolore minim
                        veniam, quism.</p>
