<%-- Document : AddProduct Created on : 22-03-2022, 15:01:27 Author : MSII --%>
										...
										<tbody>
											<c:forEach items="${listU}" var="u">
												<tr>
													...
													<td>${u.email}</td>
													<td>
														<button><a href="editUser?uID=${u.uID}">Edit</a></button>
														<button><a href="deletUser?uID=${u.uID}">Delete</a></button>
													</td>
												</tr>
											</c:forEach>
