<js <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <body>
                            ...
                            <div class="size">
                                ...
                                <div class="cart">
                                    <button onclick="addToCart()"
                                        style="padding: 10px 40px;border: none;margin: 30px 0px;" href="cart.jsp">Add To
                                        Cart</button>
                                    <script>
                                        function addToCart() {
            ...
            <div class="tabs container">
                ...
                <div class="tab-content">
                    <div class="tab-pane container active" id="home">
                        <p style="padding-top: 30px;padding-bottom: 30px;">Lorem ipsum dolor sit amet, consectetur
                            adipisicing
                            elit sed. Eiusmod
                            tempor. incididu nt ut labore
                            et dolore magna
                            aliqua. Ut enim. ad minim veniam, uis nostrud exerc itation ullamco. Laboris nisi. ut
                            aliquip ex ea
                            commodo consequat.
                            Duis aute irure dolr. inreprehen derit in voluptate velit esse cillum dolore. eu fugiat
                            nulla
            ...
            <div class="login">
                <a href="buy.jsp" class="bxuser">
                    ...
                    <c:if test="${sessionScope.acc == null}">
                        <a class="nav-link" href="login.jsp" style="background: graytext"
                            style="background: graytext">Login</a>
                    </c:if>
                </a>
