	           ...
	           <table class="table" style="width: 700px;margin-left: 120px;margin-bottom: 100px;">
                       ...
                       <tbody>
                           ...
                           <tr>
                              ...
                              <td style="width: 100px;">
                                  <button onclick="deleteCart(${cart.pID}, ${cart.sizeId})" value="DELETE"style="text-align: center;">DELETE</button>
                              </td>
                            </tr>
                            </c:forEach>
                       </tbody>
					...
					function deleteCart(pID, sizeId) {
						...
						location.href = ctx + "/DeleteCart?pID=" + pID + "&sizeId=" +sizeId;
                                        ...
                                        <div class="totalprice" style="margin-top: 50px;">
                                            <h2 style="color: #000; font-size: 50px;">Total Price :<span style="color: red">${totalPrice} VND</span></h2>
