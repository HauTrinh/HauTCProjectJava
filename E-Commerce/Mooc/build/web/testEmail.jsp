<%-- 
    Document   : testEmail
    Created on : Dec 2, 2022, 3:42:37 PM
    Author     : PC
--%>
...
<div class="login">
    <div>
        <div class="content-login" style="margin-top: 10%; text-align: center; color: rgb(77, 77, 77);">
          <h3 style="color: rgb(255, 255, 255); text-shadow: 0 2px 5px #393939;">Nhập mã code</h3>
        </div>
        <div class=" rounded login-form border border-primary" style="background-color: rgba(255, 255, 255, 0.896);">
            <span style="font-size: 1.2rem">We already send a verification  code to your email.</span><br>
            <form action="VerifyCode" method="post">
                <div style=" text-align: center; align-items: center; font-size: 1.2rem">
                    <input style=" width: 50%;" type="text" name="authcode">
                </div>
                <p class="text-danger" style=" font-size: 1.2em">${mes}</p>
                <div style=" text-align: end; align-items: flex-end;">
                    <input style=" width: 100px; font-size: 1.2rem" type="submit" value="verify">
                </div>
            </form>
        </div>
      </div>
