...
<div class="login">
    <div class="">
        <div class="content-login" style="margin-top: 10%; text-align: center; color: rgb(77, 77, 77);">
          <h3 style="color: rgb(255, 255, 255); text-shadow: 0 2px 5px #393939;">Đặt lại mật khẩu</h3>
        </div>
        <div class=" rounded login-form border border-primary" style="background-color: rgba(255, 255, 255, 0.896);">
            <form action="sendEmail" method="post">
                ...
                <div class="form-group">
                  ...
                  <input type="email" class="form-control" id="inputEmail" aria-describedby="email" placeholder="Email mà bạn dùng để đăng ký tài khoản ..." name="useremail">
                  <p class="text-danger" style=" font-size: 1.2em">${message}</p>
                </div>
                <div style="text-align: center; margin-bottom: 4%;">
                  <a href="home.jsp">Quay về trang chủ</a>
                </div>
                <div style="text-align: center;">
                    <button type="submit" class="btn btn-primary" value="Register">Gửi mã</button>
                </div>
