                ...
                <div style=" margin-top: 0" class="col-md-6 info__form">
                    <form action="editPassword" method="post">   
                            <div class="form-group">                            
                                <label>ID</label>
                                <input name="id" type="text" id="NameAccount" class="form-control" value="${sessionScope.account.id}" readonly>
                            </div>
                            <div class="form-group">   
                                <label for="">Username:</label>
                                <input class="col-md-12" type="text" name="username" value="${sessionScope.account.acc}" placeholder="Username" readonly>
                            </div>    
                            <div class="form-group">                            
                                <label for="">Old Password:</label>
                                <input class="col-md-12" type="password" name="oldword" id="" value="">
                            </div>
