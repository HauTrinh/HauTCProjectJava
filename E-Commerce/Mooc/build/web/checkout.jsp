                            ...
                            <div class="row">
                                <div class="col-lg-8 col-md-6">
                                    <div class="checkout__input">
                                        <p>Tên<span>*</span></p>
                                        <input type="text" value="${sessionScope.custom.customerName}" readonly>
                                    </div>

                                    <div class="checkout__input">
                                        <p>Địa chỉ<span>*</span></p>
                                        <input type="text" placeholder="Street Address" name="address" class="checkout__input__add"  value="${sessionScope.custom.address}" readonly>

                                    </div>
                                    <div class="checkout__input">
                                        <p>Số điện thoại<span>*</span></p>
                                        <input type="text" value="${sessionScope.custom.phone}" readonly>
                                    </div>
                                    <div class="checkout__input">
                                        <p>Email<span>*</span></p>
