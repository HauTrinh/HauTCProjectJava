<%-- 
    Document   : index
    Created on : Dec 2, 2022, 2:15:35 PM
    Author     : PC
--%>
    ...
    <body>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 mix coat man women">
                            <div class="featured__item">
                                ...
                                <div class="featured__item__text">
                                    ...
                                    <h5>${o.priceWithDot}.000 VNĐ</h5>
                                    ${o.totalProduct == 0 ? "<h6>Sản phẩm hết hàng</h6>":""}
                                </div>
                            </div>
                        </div>
                    </c:forEach>                   
        ...
        <div class="pagination">
            <c:forEach begin="1" end="${endPage}" var="o">
                <a onclick="loadPaging()" class="${tag == o?"active":""}" href="home?categoryID=${tagCategory}&index=${o}">${o}</a>
            </c:forEach>
        </div>
        <!--phân trang-->
