...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <c:if test="${sessionScope.account.roles == 2}"> <!-- Seller   -->
                    <div class="card">
                        <form action="sellerUploadImg" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card__header" style="">
                                <h2>${sessionScope.account.acc} </h2>
                ...
                <c:if test="${sessionScope.account.roles == 3}"> <!-- Customer   -->
                   <div class="card">
                ...
                <div style=" margin-top: 0" class="col-md-6 info__form">
                        ...
                        <form action="managerSeller" method="post">
                            <fieldset>
                                <div class="form-group">
                                    <label>ID</label>
                                    <input name="noID" type="text" id="NameAccount" class="form-control" value="${sessionScope.account.id}" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="NameAccount">Tên người dùng</label>
                                    <input name="noName" type="text" id="NameAccount" class="form-control" value="${no.name}">
                                </div>
                                <div class="form-group">
                                    <label for="NameAccount">Số điện thoại</label>
                                    <input name="noPhone" type="phone" id="NameAccount" class="form-control" value="${no.phone}">
                                </div>
                                <div class="form-group">
                                    <label class="labels">Địa chỉ</label>
                                    <input name="noAdd" type="text" class="form-control" value="${no.address}">
                                </div>
                            </fieldset>
                    ...
                    <c:if test="${sessionScope.account.roles == 3}">  <!--Customer   -->
                        <form action="managerCus" method="post">
                            <fieldset>
                                <div class="form-group">
                                    <label for="NameAccount">ID</label>
                                    <input name="noID" type="text" id="NameAccount" class="form-control" value="${sessionScope.account.id}" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="NameAccount">Tên người dùng</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="noAdd" type="text" id="NameAccount" class="form-control" value="${no.address}">
                                </div>
                            </fieldset>
                            <div class="modal-footer">
                                <input type="submit" class="btn btn-info" value="Lưu thay đổi" >
