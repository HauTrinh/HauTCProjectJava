                    ...
                    <div class="container">
                        ...
                        <div class="col-lg-6 col-md-6">
                            ...
                            <div class="product__details__text">
                                ...
                                <div class="product__details__price">${detail.priceWithDot}.000 VNĐ</div>
                                <!--                            <form action="detail" method="GET" id="inforDetail">-->
                                <div class="pro__detail" style="display: flex;">
                                    ...
                                    <input name="cid" value="${sessionScope.custom.customerID}" hidden>
                                    <div class="product__details-size" style="margin-left: 24px;">
                                        <h4>Màu:</h4>
                            ...
                            <div class="product__details__quantity">
                                <div class="quantity">
                                    <div class="buttons_added" style="padding-top: 16px;">
                                        ...
                                        <input name="quantity" aria-label="quantity" class="input-qty" max="100" min="1" name="" type="number" value="1">
