                                    ...
                                    <table>
                                        ...
                                        <c:forEach items="${listC}" var="c">
                                            ...
                                            <tr>
                                                ...
                                                <td><label>
                                                        <input type="checkbox" name="cbid" value="${c.cartID}" class="check">
                                                    </label>
                                                </td>
                                        ...
                                        <input name="csID" value="${sessionScope.custom.customerID}" hidden>
                                        <td class="shoping__cart__total">
                                            ${c.total}.000 VNĐ
                                        </td>
                                        <td class="shoping__cart__item__close">
                                            <a href="deleteCart?dcid=${c.cartID}" style="text-decoration: none;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="shoping__checkout">
                                <h5>Cart Total</h5>
                                <ul>
                                    <li>Subtotal <span>${total}.000 VNĐ</span></li>
                                    <li>Total <span>${total}.000 VNĐ</span></li></span></li>
                                </ul>
