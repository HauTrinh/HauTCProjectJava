                ...
                <div class="login-form border border-primary">
                    <form action="newStore" method="post">
                        <div class="form-group" hidden>
                            <label for="exampleInputAcount1">SellerID:</label>
                            <input name="sellerid"  type="text" class="form-control" id="exampleInputAcount1" value="${sessionScope.seller.id}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input name="descrip" type="message" class="form-control" id="exampleInputPassword1" placeholder="Mô tả">
                        </div>
                        <div class="form-group">
                            <label for="inputEmail4">Logo cửa hàng;</label>
                            <input name="logo" type="text" class="form-control" id="inputEmail4" placeholder="Link">
                        </div>
