 ...
 * @author LINH
 */
@WebServlet(name = "NewStore", urlPatterns = {"/newStore"})
...
//        int id = Integer.parseInt(request.getParameter("sellerid"));
        ...
        String namestore = request.getParameter("storeName");
        String descrip = request.getParameter("descrip");
        String logo = request.getParameter("logo");

        LoginDAO dao = new LoginDAO();

        dao.insertStore(id, namestore, descrip, logo);
        response.sendRedirect("qldanhthu");
    }
